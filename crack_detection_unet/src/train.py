"""ResUNet (smp) 訓練 binary craquelure segmentation, 重用 SAM2 專案的 dataset/aug/loss/metrics。"""
...
def main():
    ...
    train_names, val_names, _, fold_info = load_split(args.split, args.fold)
    ...
    print(f"model arch={args.arch} encoder={args.encoder} weights={args.encoder_weights} "
