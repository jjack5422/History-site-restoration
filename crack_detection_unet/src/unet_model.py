...
mainstream baselines compared in 2026-06-29 craquelure study (DeepLabV3+, SegFormer);
all are smp models with logits-NCHW forward and an ``encoder.`` parameter prefix so
``param_groups`` works unchanged.
"""
